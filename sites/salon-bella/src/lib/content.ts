...
export const business = {
  ...
  phone: "+49 211 555 0120",
  phoneDisplay: "0211 555 0120",
  ...
  street: "Königsallee 24",
  zip: "40212",
  city: "Düsseldorf",
  region: "NRW",
  lat: 51.2240,
  lng: 6.7785,
  url: "https://salon-bella-demo.de",
  founded: 2012,
...
export const seo = {
  title: "Friseur Düsseldorf | Salon Bella — Hair & Beauty an der Königsallee",
  description:
    "Dein Friseur in Düsseldorf: Damenhaarschnitt, Coloration, Balayage, Pflege, Braut-Styling & Beauty. Meistersalon mit kostenloser Typberatung und Premium-Produkten. Jetzt online Termin anfragen.",
  keywords: [
    "Friseur Düsseldorf",
    "Friseursalon Düsseldorf",
    "Balayage Düsseldorf",
    "Coloration",
    "Damenhaarschnitt",
    "Braut-Styling",
